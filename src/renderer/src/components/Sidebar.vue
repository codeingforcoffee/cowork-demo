...
<template>
  ...
  >
    ...
    <div
      class="h-12 flex items-center drag-region shrink-0"
    ...
    <div class="flex-1 overflow-y-auto overflow-x-hidden px-2 py-1 space-y-0.5 min-h-0">
      ...
      <template v-if="sessionsStore.groupedSessions.today.length > 0">
        <p v-if="!collapsed" class="px-2 pt-2 pb-1 text-xs text-text-tertiary font-medium">
          {{ t('common.today') }}
        </p>
              ...
              <div class="hidden group-hover:flex items-center gap-0.5 shrink-0">
                ...
                >
                  <svg width="10" height="10" viewBox="0 0 12 12" fill="none">
                    <path
                      d="M8.5 1.5L10.5 3.5L4 10H2v-2l6.5-6.5z"
                      stroke="currentColor"
                      stroke-width="1.2"
                ...
                >
                  <svg width="10" height="10" viewBox="0 0 12 12" fill="none">
                    <path
                      d="M2 3h8M5 3V2h2v1M4.5 5v4M7.5 5v4M3 3l.5 7h5L9 3"
                      stroke="currentColor"
                      stroke-width="1.2"
                      stroke-linecap="round"
                      stroke-linejoin="round"
